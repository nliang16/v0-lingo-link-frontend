      ...
      <div className="flex-1 grid lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-card rounded-xl p-6 border border-border shadow-sm">
            ...
            {gameState.refreshedToCountry && (
              <div className="flex items-center gap-2 text-sm text-amber-600 dark:text-amber-400 bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 rounded-lg px-3 py-2 mb-2">
                <AlertCircle className="w-4 h-4 flex-shrink-0" />
                <span>No moves left from last country — teleported to <strong>{gameState.refreshedToCountry}</strong>!</span>
              </div>
            )}
